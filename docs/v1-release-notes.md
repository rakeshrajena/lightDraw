...
- **[v1.2.1 release notes](./v1.2.1-release-notes.md)** — built-in diagram flow/zoom toolbar (current)
- **[v1.2.0 release notes](./v1.2-release-notes.md)** — wire flow status tint, CAN hops, multi-series / dataTable, telltales
