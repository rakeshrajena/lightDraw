...
const CORE_MAX_GZIP = 24 * 1024; // v0.9.0 baseline; aspirational target is 8 KB (see IMPLEMENTATION_PLAN)
...
describe('Phase 5 — Modular Bundle Architecture', () => {
  ...
  it('core bundle gzip size is within documented baseline (≤ 24 KB)', () => {
    const path = 'dist/lightdraw.core.min.js';
    expect(existsSync(path)).toBe(true);
